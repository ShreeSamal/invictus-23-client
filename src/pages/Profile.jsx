  ...
  return (
    ...
    <div className="content-list">
      <ul className="aside-list">
        ...
        <li className="asideItem"><Link to='#' style={{ textDecoration: 'none', color: '#fff', fontSize: '20px', display: 'block', width: '100%', height: '100%' }}><i class="bi bi-exclamation-circle icon"></i>Anonymous Lead</Link></li>
      </ul>
    </div>
  </aside>
    </>
