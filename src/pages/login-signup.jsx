        ...
        <div className="login-main">
            ...
            <div className="signup">
                <form>
                    ...
                    <input type="text" onChange={(e)=>{setName(e.target.value)}} name="txt" placeholder="name" required=""></input>
                    <input type="tel" pattern="[0-9]{10}" onChange={(e)=>{setContact(e.target.value)}} name="contact" placeholder="Contact" required=""></input>
